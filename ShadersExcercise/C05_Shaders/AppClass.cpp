...
{
	m_uShaderProgramID = LoadShaders("Shaders//MyBasicColor.vs", "Shaders//MyBasicColor.fs");
...
void AppClass::Display(void)
{
	...
	GLuint invNum = glGetUniformLocation(m_uShaderProgramID, "inverse");
	glUniform1i(invNum, inverse);
