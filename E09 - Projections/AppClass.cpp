...
void Application::Display(void)
{
	...
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, -15.0f), vector3(0.0f, 0.0f, 1.0f), vector3(0.0f, 1.0f, 0.0f));
		break;
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, -10.0f), vector3(0.0f, 0.0f, 1.0f), vector3(0.0f, 1.0f, 0.0f));
		break;
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, -15.0f), vector3(0.0f, 0.0f, 1.0f), vector3(0.0f, 1.0f, 0.0f));
