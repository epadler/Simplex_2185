...
void Application::Display(void)
{
	...
	quaternion q1, q2, q3;
	q1 = glm::angleAxis(glm::radians(m_v3Rotation.x), vector3(1.0f, 0.0f, 0.0f));
	q2 = glm::angleAxis(glm::radians(m_v3Rotation.y), vector3(0.0f, 1.0f, 0.0f));
	q3 = glm::rotate(glm::radians(m_v3Rotation.z), vector3(0.0f, 0.0f, 1.0f));
